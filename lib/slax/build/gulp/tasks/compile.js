...
module.exports = function(done) {
    ...
    async.waterfall([
        ...
        function(next) {
            ...
            console.log( nfs.join(settings.directories.src, './pages'));
            console.log( nfs.join(settings.directories.obj, './pages'));

            nfs.copy(
                nfs.join(settings.directories.src, './pages'),
                nfs.join(settings.directories.obj, './pages'),
                next
            );
        },        
        function(next) {
