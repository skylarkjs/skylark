...
define("skylark/skylark", [], function() {
    var skylark = {
...
define("skylark/langx", ["skylark/skylark"], function(skylark) {
...
define("skylark/touchx", [], function() {
...
define("skylark/query", [
    ...
    var query = (function() {
        ...
        langx.mixin($.fn, {
            ...
            parents: wrapper_selector(finder.ancestors, finder, true),

            parent: wrapper_selector(finder.parent, finder, true),

            children: wrapper_selector(finder.children, finder, true),

            contents: wrapper_map(noder.contents, noder),

            siblings: wrapper_selector(finder.siblings, finder, true),
